...
Namespace My
    ''' <summary>
    ''' Modul pro definici vlastností, které jsou dostupné v nabídce Můj obor názvů pro WPF
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Module MyWpfExtension
        ...
        ''' <summary>
        ''' Pro běžící aplikaci vrátí aplikační objekt
        ''' </summary>
        ...
        End Property
        ''' <summary>
        ''' Vrací informace pro aktuálního uživatele.  Pokud chcete spustit aplikaci s aktuálním 
        ''' pověřením uživatele Windows, zavolejte My.User.InitializeWithWindowsUser().
        ''' </summary>
        <Global.System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")>  _
        ...
        End Property
        ''' <summary>
        ''' Vrací aplikační protokol. Naslouchací procesy lze nastavit v konfiguračním souboru aplikace.
        ''' </summary>
        <Global.System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")>  _
        ...
        ''' <summary>
        ''' Vrací kolekci oken definovaných v projektu.
        ''' </summary>
        <Global.System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")>  _
